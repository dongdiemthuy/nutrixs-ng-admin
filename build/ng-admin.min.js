...
define('ng-admin/Main/component/controller/AppController',[],function () {
...
define('ng-admin/Main/component/controller/DashboardController',['require'],function (require) {
...
define('ng-admin/Main/component/controller/SidebarController',[],function () {
...
define('ng-admin/Main/component/service/PanelBuilder',[],function () {
...
define('ng-admin/Main/component/service/Validator',[],function () {
...
define('ng-admin/Main/component/service/config/Configurable',[],function () {
...
define('ng-admin/Main/component/service/config/Application',['require','angular','ng-admin/Main/component/service/config/Configurable'],function (require) {
...
define('ng-admin/lib/utils',[],function () {
...
define('ng-admin/Main/component/service/config/Field',['require','angular','ng-admin/Main/component/service/config/Configurable','ng-admin/lib/utils'],function (require) {
...
define('ng-admin/Main/component/service/config/Entry',[],function () {
...
define('ng-admin/Main/component/service/config/view/View',['require','angular','ng-admin/Main/component/service/config/Entry','ng-admin/Main/component/service/config/Configurable'],function (require) {
...
define('ng-admin/Main/component/service/config/view/ListView',['require','angular','ng-admin/Main/component/service/config/view/View','ng-admin/Main/component/service/config/Field','ng-admin/Main/component/service/config/Configurable','ng-admin/lib/utils'],function (require) {
...
define('ng-admin/Main/component/service/config/view/DashboardView',['require','angular','ng-admin/Main/component/service/config/view/ListView','ng-admin/Main/component/service/config/Configurable','ng-admin/lib/utils'],function (require) {
...
define('ng-admin/Main/component/service/config/view/MenuView',['require','angular','ng-admin/Main/component/service/config/Configurable'],function (require) {
...
define('ng-admin/Main/component/service/config/view/ShowView',['require','angular','ng-admin/Main/component/service/config/view/View','ng-admin/lib/utils'],function (require) {
...
define('ng-admin/Main/component/service/config/view/CreateView',['require','angular','ng-admin/Main/component/service/config/view/View','ng-admin/lib/utils'],function (require) {
...
define('ng-admin/Main/component/service/config/view/EditView',['require','angular','ng-admin/Main/component/service/config/view/View','ng-admin/lib/utils'],function (require) {
...
define('ng-admin/Main/component/service/config/view/DeleteView',['require','angular','ng-admin/Main/component/service/config/view/View','ng-admin/lib/utils'],function (require) {
...
define('ng-admin/Main/component/service/config/Reference',['require','angular','ng-admin/Main/component/service/config/Configurable','ng-admin/Main/component/service/config/view/ListView','ng-admin/Main/component/service/config/Field','ng-admin/lib/utils'],function (require) {
...
define('ng-admin/Main/component/service/config/ReferencedList',['require','ng-admin/Main/component/service/config/Configurable','ng-admin/Main/component/service/config/Reference','ng-admin/lib/utils'],function (require) {
...
define('ng-admin/Main/component/service/config/ReferenceMany',['require','ng-admin/Main/component/service/config/Configurable','ng-admin/Main/component/service/config/Reference','ng-admin/lib/utils'],function (require) {
...
define('ng-admin/Main/component/service/config/ReferenceManyObject',['require','ng-admin/Main/component/service/config/Configurable','ng-admin/Main/component/service/config/Reference','ng-admin/lib/utils'],function (require) {
...
define('ng-admin/Main/component/service/config/ReferenceManyAggregation',['require','ng-admin/Main/component/service/config/Configurable','ng-admin/Main/component/service/config/Reference','ng-admin/lib/utils'],function (require) {
...
define('ng-admin/Main/component/provider/NgAdminConfiguration',[],function () {
...
define('ng-admin/Main/component/filter/OrderElement',[],function () {
...
define('text!ng-admin/Main/view/dashboard-panel.html',[],function () { return '<div class="panel-heading">\n    {{ panel.label | translate}}\n</div>\n\n<datagrid with-pagination="false"></datagrid>\n';});

/*global define*/

define('ng-admin/Main/component/directive/DashboardPanel',['require','text!../../view/dashboard-panel.html'],function (require) {
...
define('text!ng-admin/Main/view/menu.html',[],function () { return '<div class="navbar-default sidebar" role="navigation">\n    <div class="sidebar-nav navbar-collapse">\n        <ul class="nav" id="side-menu">\n            <li class="entities-repeat" ng-repeat="(key, entity) in sidebarController.entities">\n                <a ng-click="sidebarController.displayList(entity, $event)" ng-class="{\'active\': sidebarController.isActive(entity)}"><span ng-bind-html="sidebarController.getIconForEntity(entity)"></span> {{ entity.menuView().title() || entity.label() | translate }}</a>\n            </li>\n        </ul>\n    </div>\n</div>\n';});

/*global define*/

define('ng-admin/Main/component/directive/Menu',['require','text!../../view/menu.html'],function (require) {
...
define('ng-admin/Main/config/http',[],function () {
...
define('text!ng-admin/Main/view/layout.html',[],function () { return '<div id="wrapper">\n    <nav id="header-nav" class="navbar navbar-default navbar-static-top" role="navigation">\n        <div class="navbar-header">\n            <a href="#" class="navbar-brand">{{ appController.applicationName }}</a>\n        </div>\n\n        <span ng-controller="SidebarController as sidebarController">\n            <menu></menu>\n        </span>\n    </nav>\n\n    <div id="page-wrapper">\n        <div class="main-container container-fluid" ui-view></div>\n    </div>\n    <div id="loader"></div>\n</div>\n';});


define('text!ng-admin/Main/view/dashboard.html',[],function () { return '<div class="row">\n    <div class="col-lg-12">\n        <h1 class="page-header"> {{\'ngAdmin.static.DASHBOARD\' | translate}} </h1>\n    </div>\n</div>\n\n<div class="row dashboard-content">\n    <div class="panel panel-default col-lg-5" ng-repeat="panel in dashboardController.panels" ng-init="columns=panel.columns;entries=panel.entries;view=panel.view">\n        <dashboard-panel></dashboard-panel>\n    </div>\n</div>\n';});

/*global define*/

define('ng-admin/Main/config/routing',['require','text!../view/layout.html','text!../view/dashboard.html'],function (require) {
...
define('ng-admin/Main/run/Loader',[],function () {
 ...
 */
(function(a,b){if(typeof define==="function"&&define.amd){define('inflection',[],b);
...
define("angular-bootstrap-tpls", ["angular","angular-bootstrap"], function(){});
...
define('ng-admin/Crud/list/ListController',[],function () {
...
define('ng-admin/Crud/show/ShowController',[],function () {
...
define('ng-admin/Crud/form/FormController',[],function () {
...
define('ng-admin/Crud/delete/DeleteController',[],function () {
...
define('ng-admin/Crud/repository/Queries',[],function () {
...
/*global define*/
define('ng-admin/Crud/repository/RetrieveQueries',['require','ng-admin/lib/utils','ng-admin/Crud/repository/Queries'],function (require) {
...
/*global define*/
define('ng-admin/Crud/repository/CreateQueries',['require','ng-admin/lib/utils','ng-admin/Crud/repository/Queries'],function (require) {
...
/*global define*/
define('ng-admin/Crud/repository/UpdateQueries',['require','ng-admin/lib/utils','ng-admin/Crud/repository/Queries'],function (require) {
...
/*global define*/
define('ng-admin/Crud/repository/DeleteQueries',['require','ng-admin/lib/utils','ng-admin/Crud/repository/Queries'],function (require) {
...
define('text!ng-admin/Crud/field/StringField.html',[],function () { return '<input id="{{ field.name() }}"\n       name="{{ field.name() }}"\n       class="{{ field.getCssClasses() }}"\n       type="text"\n       ng-model="entry.values[field.name()]"\n       ng-required="field.validation().required"\n       ng-minlength="{{ field.validation().minlength }}"\n       ng-maxlength="{{ field.validation().maxlength }}" />\n';});

/*global define*/

define('ng-admin/Crud/field/StringField',['require','text!./StringField.html'],function (require) {
...
define('text!ng-admin/Crud/field/PasswordField.html',[],function () { return '<input id="{{ field.name() }}"\n       name="{{ field.name() }}"\n       class="{{ field.getCssClasses() }}"\n       type="password"\n       ng-model="entry.values[field.name()]"\n       ng-required="field.validation().required"\n       ng-minlength="{{ field.validation().minlength }}"\n       ng-maxlength="{{ field.validation().maxlength }}" />\n';});

/*global define*/

define('ng-admin/Crud/field/PasswordField',['require','text!./PasswordField.html'],function (require) {
...
define('text!ng-admin/Crud/field/EmailField.html',[],function () { return '<input id="{{ field.name() }}"\n       name="{{ field.name() }}"\n       class="{{ field.getCssClasses() }}"\n       type="email"\n       ng-model="entry.values[field.name()]"\n       ng-required="field.validation().required"\n       ng-minlength="{{ field.validation().minlength }}"\n       ng-maxlength="{{ field.validation().maxlength }}"/>\n';});

/*global define*/

define('ng-admin/Crud/field/EmailField',['require','text!./EmailField.html'],function (require) {
...
define('text!ng-admin/Crud/field/TextField.html',[],function () { return '<textarea\n        id="{{ field.name() }}"\n        name="{{ field.name() }}"\n        class="form-control"\n        ng-model="entry.values[field.name()]"\n        ng-required="field.validation().required"\n        ng-minlength="{{ field.validation().minlength }}"\n        ng-maxlength="{{ field.validation().maxlength }}"></textarea>\n';});

/*global define*/

define('ng-admin/Crud/field/TextField',['require','text!./TextField.html'],function (require) {
...
define('text!ng-admin/Crud/field/NumberField.html',[],function () { return '<input id="{{ field.name() }}"\n       name="{{ field.name() }}"\n       class="{{ field.getCssClasses() }}"\n       type="number"\n       step="{{ field.validation().step || \'any\' }}"\n       max="{{ field.validation().max }}"\n       ng-model="entry.values[field.name()]"\n       ng-required="field.validation().required" />\n';});

/*global define*/

define('ng-admin/Crud/field/NumberField',['require','text!./NumberField.html'],function (require) {
...
define('text!ng-admin/Crud/field/DateField.html',[],function () { return '<div class="input-group datepicker col-sm-4">\n    <input id="{{ field.name() }}"\n           name="{{ field.name() }}"\n           class="{{ field.getCssClasses() }}"\n           type="text"\n           datepicker-popup="{{ field.format() }}"\n           ng-model="entry.values[field.name()]"\n           ng-required="field.validation().required"\n           is-open="isOpen"\n           close-text="Close" />\n\n    <span class="input-group-btn">\n        <button type="button" class="btn btn-default" ng-click="toggleDatePicker($event)"><i class="glyphicon glyphicon-calendar"></i></button>\n    </span>\n</div>\n';});

/*global define*/

define('ng-admin/Crud/field/DateField',['require','text!./DateField.html'],function (require) {
...
define('text!ng-admin/Crud/field/BooleanField.html',[],function () { return '<input id="{{ field.name() }}"\n       name="{{ field.name() }}"\n       type="checkbox"\n       class="{{ field.getCssClasses() }}"\n       ng-model="entry.values[field.name()]"\n       ng-required="field.validation().required" />\n';});

/*global define*/

define('ng-admin/Crud/field/BooleanField',['require','text!./BooleanField.html'],function (require) {
...
define('text!ng-admin/Crud/field/ChoiceField.html',[],function () { return '<select id="{{ field.name() }}"\n        name="{{ field.name() }}"\n        class="{{ field.getCssClasses() }}"\n        ng-model="entry.values[field.name()]"\n        ng-required="field.validation().required">\n\n    <option ng-if="!field.validation().required">-- select a value --</option>\n\n    <option ng-repeat="choice in field.choices()" value="{{ choice.value }}" ng-selected="entry.values[field.name()] == choice.value">\n        {{ choice.label }}\n    </option>\n</select>\n';});

/*global define*/

define('ng-admin/Crud/field/ChoiceField',['require','text!./ChoiceField.html'],function (require) {
...
define('text!ng-admin/Crud/field/ChoicesField.html',[],function () { return '<select id="{{ field.name() }}"\n        name="{{ field.name() }}"\n        class="{{ field.getCssClasses() }}"\n        multiple\n        ng-model="entry.values[field.name()]"\n        ng-multiple="{{ field.multiple }}"\n        ng-options="option as option for option in field.choices"\n        ng-required="field.validation().required"></select>\n';});

/*global define*/

define('ng-admin/Crud/field/ChoicesField',['require','text!./ChoicesField.html'],function (require) {
...
define('text!ng-admin/Crud/field/ReferenceField.html',[],function () { return '<select id="{{ field.name() }}"\n        name="{{ field.name() }}"\n        class="form-control"\n        ng-model="entry.values[field.name()]"\n        ng-required="field.validation().required">\n\n    <option ng-if="!field.validation().required">-- select a value --</option>\n    <option ng-repeat="choice in choices" value="{{ choice.id }}" ng-selected="entry.values[field.name()] == choice.id">\n        {{ choice.value }}\n    </option>\n</select>\n';});

/*global define*/

define('ng-admin/Crud/field/ReferenceField',['require','text!./ReferenceField.html'],function (require) {
...
define('text!ng-admin/Crud/field/ReferenceManyField.html',[],function () { return '<select id="{{ field.name() }}"\n        name="{{ field.name() }}"\n        class="form-control"\n        ng-model="entry.values[field.name()]"\n        ng-multiple="true" multiple\n        ng-required="field.validation().required">\n\n    <option ng-repeat="choice in choices" value="{{ choice.id }}"\n            ng-selected="referenceManyField.contains(entry.values[field.name()], choice.id)" >\n        {{ choice.value }}\n    </option>\n</select>\n';});

/*global define*/

define('ng-admin/Crud/field/ReferenceManyField',['require','text!./ReferenceManyField.html'],function (require) {
...
define('text!ng-admin/Crud/field/ReferenceManyObjectField.html',[],function () { return '<select id="{{ field.name() }}"\n        name="{{ field.name() }}"\n        class="form-control"\n        ng-model="entry.values[field.name()]"\n        ng-multiple="true" multiple\n        ng-required="field.validation().required">\n\n    <option ng-repeat="choice in choices" value="{{ choice.id }}"\n            ng-selected="referenceManyObjectField.contains(entry.values[field.name()], choice.id)" >\n        {{ choice.value }}\n    </option>\n</select>\n';});

/*global define*/

define('ng-admin/Crud/field/ReferenceManyObjectField',['require','text!./ReferenceManyObjectField.html'],function (require) {
...
define('text!ng-admin/Crud/field/WysiwygField.html',[],function () { return '<div id="{{ field.getName() }}"\n     name="{{ field.name() }}"\n     text-angular\n     ng-model="entry.values[field.name()]"\n     ta-text-editor-class="border-around"\n     ta-html-editor-class="border-around"></div>\n';});

/*global define*/

define('ng-admin/Crud/field/WysiwygField',['require','text!./WysiwygField.html'],function (require) {
...
define('text!ng-admin/Crud/field/TemplateField.html',[],function () { return '<span compile="field.getTemplateValue(field)"></span>\n';});

/*global define*/

define('ng-admin/Crud/field/TemplateField',['require','text!./TemplateField.html'],function (require) {
...
define('text!ng-admin/Crud/list/ListActions.html',[],function () { return '<span compile="customTemplate">\n    <span ng-repeat="button in buttons" ng-switch="button">\n        <show-button ng-switch-when="show" entry="entry" entity="entity" size="xs"></show-button>\n        <edit-button ng-switch-when="edit" entry="entry" entity="entity" size="xs"></edit-button>\n        <delete-button ng-switch-when="delete" entry="entry" entity="entity" size="xs"></delete-button>\n    </span>\n</span>\n';});

/*global define*/

define('ng-admin/Crud/list/ListActions',['require','text!./ListActions.html'],function (require) {
...
define('text!ng-admin/Crud/list/Datagrid.html',[],function () { return '<table class="grid table table-condensed table-hover table-striped">\n    <thead>\n        <tr>\n            <th ng-repeat="field in fields | orderElement track by $index" ng-class="\'ng-admin-column-\' + field.name()">\n                <a ng-click="datagrid.sort(field)">\n                    <span class="glyphicon {{ sortDir === \'DESC\' ? \'glyphicon-chevron-down\': \'glyphicon-chevron-up\' }}" ng-if="datagrid.isSorting(field)"></span>\n\n                    {{ field.label() | translate}}\n                </a>\n            </th>\n            <th ng-if="listActions">\n                {{\'ngAdmin.static.ACTIONS\' | translate}}\n            </th>\n        </tr>\n    </thead>\n\n    <tbody>\n        <tr ng-class="datagrid.itemClass($index)" ng-repeat="entry in entries track by $index">\n            <td ng-repeat="field in fields | orderElement track by $index" ng-switch="field.type()">\n                <string-column ng-switch-when="string"></string-column>\n\n                <password-column ng-switch-when="password"></password-column>\n\n                <text-column ng-switch-when="text"></text-column>\n\n                <email-column ng-switch-when="email"></email-column>\n\n                <number-column ng-switch-when="number"></number-column>\n\n                <date-column ng-switch-when="date"></date-column>\n\n                <boolean-column ng-switch-when="boolean"></boolean-column>\n\n                <choice-column ng-switch-when="choice"></choice-column>\n\n                <reference-column ng-switch-when="Reference"></reference-column>\n\n                <reference-many-column ng-switch-when="ReferenceMany"></reference-many-column>\n\n                <reference-many-object-grid ng-switch-when="ReferenceManyObject"></reference-many-object-grid>\n\n                <reference-many-aggregation-grid ng-switch-when="ReferenceManyAggregation"></reference-many-aggregation-grid>\n\n                <wysiwyg-column ng-switch-when="wysiwyg"></wysiwyg-column>\n\n                <template-column ng-switch-when="template"></template-column>\n            </td>\n            <th ng-if="listActions">\n                <list-actions entry="entry" entity="entity" buttons="listActions"></list-actions>\n            </th>\n\n        </tr>\n    </tbody>\n</table>\n\n<datagrid-pagination></datagrid-pagination>\n';});

/*global define*/

define('ng-admin/Crud/list/DatagridController',[],function () {
...
define('ng-admin/Crud/list/Datagrid',['require','text!./Datagrid.html','./DatagridController'],function (require) {
...
define('ng-admin/Crud/list/DatagridPagination',['require','angular','text!./DatagridPagination.html','./DatagridPaginationController'],function (require) {
...
define('text!ng-admin/Crud/list/QuickFilter.html',[],function () { return '<ul class="quick-filters nav nav-pills" ng-if="quickFilterCtrl.quickFilters.length">\n    <li>\n        <span>Filters:</span>\n    </li>\n    <li ng-class="{active: !quickFilterCtrl.currentQuickFilter}">\n        <a ng-click="quickFilterCtrl.filter(null)">None</a>\n    </li>\n    <li ng-repeat="label in quickFilterCtrl.quickFilters" ng-class="{active: quickFilterCtrl.currentQuickFilter === label}">\n        <a ng-click="quickFilterCtrl.filter(label)">{{ label }}</a>\n    </li>\n</ul>\n';});

/*global define*/

define('ng-admin/Crud/list/QuickFilterController',[],function () {
...
define('ng-admin/Crud/list/QuickFilter',['require','text!./QuickFilter.html','./QuickFilterController'],function (require) {
...
define('text!ng-admin/Crud/column/StringColumn.html',[],function () { return '<div ng-switch="field.isDetailLink()" ng-init="value = entry.values[field.name()]">\n    <a ng-switch-when="true" ng-click="gotoDetail(entry)">{{ value }}</a>\n\n    <span ng-switch-default>{{ value }}</span>\n</div>\n';});

/*global define*/

define('ng-admin/Crud/column/StringColumn',['require','text!./StringColumn.html'],function (require) {
...
define('text!ng-admin/Crud/column/PasswordColumn.html',[],function () { return '<div ng-switch="field.isDetailLink()">\n    <a ng-switch-when="true" ng-click="gotoDetail(entry)">xxx</a>\n\n    <span ng-switch-default>xxx</span>\n</div>\n';});

/*global define*/

define('ng-admin/Crud/column/PasswordColumn',['require','text!./PasswordColumn.html'],function (require) {
...
define('text!ng-admin/Crud/column/EmailColumn.html',[],function () { return '<div ng-switch="field.isDetailLink()" ng-init="value = entry.values[field.name()]">\n    <a ng-switch-when="true" ng-click="gotoDetail(entry)">{{ value }}</a>\n\n    <span ng-switch-default>{{ value }}</span>\n</div>\n';});

/*global define*/

define('ng-admin/Crud/column/EmailColumn',['require','text!./EmailColumn.html'],function (require) {
...
define('text!ng-admin/Crud/column/TextColumn.html',[],function () { return '<div ng-switch="field.isDetailLink()" ng-init="value = entry.values[field.name()]">\n    <a ng-switch-when="true" ng-click="gotoDetail(entry)">{{ value }}</a>\n\n    <span ng-switch-default>{{ value }}</span>\n</div>\n';});

/*global define*/

define('ng-admin/Crud/column/TextColumn',['require','text!./TextColumn.html'],function (require) {
...
define('text!ng-admin/Crud/column/NumberColumn.html',[],function () { return '<div ng-switch="field.isDetailLink()" ng-init="value = entry.values[field.name()]">\n    <a ng-switch-when="true" ng-click="gotoDetail(entry)">{{ value }}</a>\n\n    <span ng-switch-default>{{ value }}</span>\n</div>\n';});

/*global define*/

define('ng-admin/Crud/column/NumberColumn',['require','text!./NumberColumn.html'],function (require) {
...
define('text!ng-admin/Crud/column/DateColumn.html',[],function () { return '<div ng-switch="field.isDetailLink()" ng-init="value = (entry.values[field.name()] | date:field.format())">\n    <a ng-switch-when="true" ng-click="gotoDetail(entry)">{{ value }}</a>\n\n    <span ng-switch-default>{{ value }}</span>\n</div>\n';});

/*global define*/

define('ng-admin/Crud/column/DateColumn',['require','text!./DateColumn.html'],function (require) {
...
define('text!ng-admin/Crud/column/ChoiceColumn.html',[],function () { return '<div ng-switch="field.isDetailLink()" ng-init="value = entry.values[field.name()]">\n    <a ng-switch-when="true" ng-click="gotoDetail(entry)">{{ value }}</a>\n\n    <span ng-switch-default>{{ value }}</span>\n</div>\n';});

/*global define*/

define('ng-admin/Crud/column/ChoiceColumn',['require','text!./ChoiceColumn.html'],function (require) {
...
define('text!ng-admin/Crud/column/ChoicesColumn.html',[],function () { return '<div ng-switch="field.isDetailLink()">\n\n    <a ng-switch-when="true"  ng-click="gotoDetail(entry)" class="multiple">\n        <span ng-repeat="ref in entry.values[field.name()] track by $index" class="label label-default">\n            {{ ref }}\n        </span>\n    </a>\n\n    <span ng-switch-default>\n        <span ng-repeat="ref in entry.values[field.name()] track by $index" class="label label-default">\n            {{ ref }}\n        </span>\n    </span>\n</div>\n';});

/*global define*/

define('ng-admin/Crud/column/ChoicesColumn',['require','text!./ChoicesColumn.html'],function (require) {
...
define('text!ng-admin/Crud/column/ReferenceColumn.html',[],function () { return '<div ng-switch="field.isDetailLink() && hasRelatedAdmin()" ng-init="value = entry.listValues[field.name()]">\n    <a ng-switch-when="true" ng-click="gotoReference(entry)">{{ value }}</a>\n\n    <span ng-switch-default>{{ value }}</span>\n</div>\n';});

/*global define*/

define('ng-admin/Crud/column/ReferenceColumn',['require','text!./ReferenceColumn.html'],function (require) {
...
define('text!ng-admin/Crud/column/ReferenceManyObjectColumn.html',[],function () { return '<div ng-switch="field.isDetailLink() && hasRelatedAdmin()">\n    <ul>\n    <span ng-switch-when="true" ng-repeat="ref in entry.listValues[field.name()] track by $index">\n        <li>\n        <a ng-click="gotoReference(entry.values[field.name()][$index])" class="multiple">\n            <span class="label label-default">\n                {{ ref }} - {{field.name()}}\n            </span>\n        </a>\n        </li>\n    </span>\n    </ul>\n\n    <span ng-switch-default ng-repeat="ref in entry.listValues[field.name()] track by $index">\n        <span class="label label-default">\n            {{ ref }}\n        </span>\n    </span>\n</div>\n';});

/*global define*/

define('ng-admin/Crud/column/ReferenceManyObjectColumn',['require','text!./ReferenceManyObjectColumn.html'],function (require) {
...
define('text!ng-admin/Crud/column/ReferenceManyObjectGrid.html',[],function () { return '<div ng-switch="field.isDetailLink() && hasRelatedAdmin()">\n    <span ng-switch-when="true" ng-repeat="ref in entry.listValues[field.name()] track by $index">\n        <a ng-click="gotoReference(entry.values[field.name()][$index])" class="multiple">\n            <span class="label label-default">\n                {{ ref }}\n            </span>\n        </a>\n    </span>\n\n    <span ng-switch-default ng-repeat="ref in entry.listValues[field.name()] track by $index">\n        <span class="label label-default">\n            {{ ref }}\n        </span>\n    </span>\n</div>\n';});

/*global define*/

define('ng-admin/Crud/column/ReferenceManyObjectGrid',['require','text!./ReferenceManyObjectGrid.html'],function (require) {
...
define('text!ng-admin/Crud/column/ReferenceManyAggregationGrid.html',[],function () { return '<div ng-switch="field.isDetailLink() && hasRelatedAdmin()">\n    <span ng-switch-when="true" ng-repeat="ref in entry.listValues[field.name()] track by $index">\n        <a ng-click="gotoReference(entry.values[field.name()][$index])" class="multiple">\n            <span class="label label-default">\n                {{ ref }}\n            </span>\n        </a>\n    </span>\n\n    <span ng-switch-default ng-repeat="ref in entry.listValues[field.name()] track by $index">\n        <span class="label label-default">\n            {{ ref }}\n        </span>\n    </span>\n</div>\n';});

/*global define*/

define('ng-admin/Crud/column/ReferenceManyAggregationGrid',['require','text!./ReferenceManyAggregationGrid.html'],function (require) {
...
define('text!ng-admin/Crud/column/ReferenceManyAggregationColumn.html',[],function () { return '<div ng-switch="field.isDetailLink() && hasRelatedAdmin()">\n    \n    <table class="grid table table-condensed table-hover table-striped">\n        <tr>\n            <td ng-hide= "col[\'hide\']" ng-repeat="col in columns" > {{col[\'label\'] | translate}}  </td>\n            <!--<td></td>--> \n        </tr>\n       \n        <tr ng-hide= "col[\'hide\']" ng-switch-when="true" ng-repeat="ref in entry.values[field.name()] track by $index">\n            <td ng-hide= "col[\'hide\']" ng-repeat="col in columns"> {{ref[col[\'name\']]}} </td>\n            <!--\n            <td> <a ng-click="gotoReference(entry.values[field.name()][$index])" class="multiple">link</a></td>\n            -->\n        </tr>\n    </table>\n\n    <span ng-hide= "col[\'hide\']"  ng-switch-default ng-repeat="ref in entry.values[field.name()] track by $index" >\n        <span  ng-hide= "col[\'hide\']" class="label label-default">\n            {{ ref }}\n        </span>\n    </span>\n</div>\n';});

/*global define*/

define('ng-admin/Crud/column/ReferenceManyAggregationColumn',['require','text!./ReferenceManyAggregationColumn.html'],function (require) {
...
define('text!ng-admin/Crud/column/WysiwygColumn.html',[],function () { return '<div ng-switch="field.isDetailLink()" ng-init="value = entry.values[field.name()]">\n    <a ng-switch-when="true" ng-bind-html="value" ng-click="gotoDetail(entry)"></a>\n\n    <span ng-switch-default ng-bind-html="value"></span>\n</div>\n';});

/*global define*/

define('ng-admin/Crud/column/WysiwygColumn',['require','text!./WysiwygColumn.html'],function (require) {
...
define('text!ng-admin/Crud/column/TemplateColumn.html',[],function () { return '<span compile="view.getField(field.name()).getTemplateValue(entry)"></span>\n';});

/*global define*/

define('ng-admin/Crud/column/TemplateColumn',['require','text!./TemplateColumn.html'],function (require) {
...
define('text!ng-admin/Crud/button/BackButton.html',[],function () { return '<a class="btn btn-default" ng-class="size ? \'btn-\' + size : \'\'" ng-click="back()">\n    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>&nbsp;{{ \'ngAdmin.static.BACK\' | translate }}\n</a>\n';});

/*global define*/

define('ng-admin/Crud/button/BackButton',['require','text!./BackButton.html'],function (require) {
...
define('text!ng-admin/Crud/button/CreateButton.html',[],function () { return '<a class="btn btn-default" ng-class="size ? \'btn-\' + size : \'\'" ng-click="gotoCreate()">\n    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>&nbsp;{{\'ngAdmin.static.CREATE\' | translate}}\n</a>\n';});

/*global define*/

define('ng-admin/Crud/button/CreateButton',['require','text!./CreateButton.html'],function (require) {
...
define('text!ng-admin/Crud/button/EditButton.html',[],function () { return '<a class="btn btn-default" ng-class="size ? \'btn-\' + size : \'\'" ng-click="gotoEdit()">\n    <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp;{{\'ngAdmin.static.EDIT\' | translate}}\n</a>\n';});

/*global define*/

define('ng-admin/Crud/button/EditButton',['require','text!./EditButton.html'],function (require) {
...
define('text!ng-admin/Crud/button/ShowButton.html',[],function () { return '<a class="btn btn-default" ng-class="size ? \'btn-\' + size : \'\'" ng-click="gotoShow()">\n    <span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>&nbsp;{{\'ngAdmin.static.SHOW_BUT\'| translate}}\n</a>\n';});

/*global define*/

define('ng-admin/Crud/button/ShowButton',['require','text!./ShowButton.html'],function (require) {
...
define('text!ng-admin/Crud/button/ListButton.html',[],function () { return '<a class="btn btn-default" ng-class="size ? \'btn-\' + size : \'\'" ng-click="gotoList()">\n    <span class="glyphicon glyphicon-list" aria-hidden="true"></span>&nbsp;{{\'ngAdmin.static.LIST\' |translate}}\n</a>\n';});

/*global define*/

define('ng-admin/Crud/button/ListButton',['require','text!./ListButton.html'],function (require) {
...
define('text!ng-admin/Crud/button/DeleteButton.html',[],function () { return '<a class="btn btn-default" ng-class="size ? \'btn-\' + size : \'\'" ng-click="gotoDelete()">\n    <span class="glyphicon glyphicon-trash" aria-hidden="true"></span>&nbsp;{{ \'ngAdmin.static.DELETE\' | translate }}\n</a>\n';});

/*global define*/

define('ng-admin/Crud/button/DeleteButton',['require','text!./DeleteButton.html'],function (require) {
...
define('text!ng-admin/Crud/misc/view-actions.html',[],function () { return '<span ng-repeat="button in buttons" ng-switch="button" class="view_actions">\n    <back-button ng-switch-when="back"></back-button>\n    <list-button ng-switch-when="list" entity="entity"></list-button>\n    <create-button ng-switch-when="create" entity="entity"></create-button>\n    <show-button ng-switch-when="show" entry="entry" entity="entity"></show-button>\n    <edit-button ng-switch-when="edit" entry="entry" entity="entity"></edit-button>\n    <delete-button ng-switch-when="delete" entry="entry" entity="entity"></delete-button>\n</span>\n';});

/*global define*/

define('ng-admin/Crud/misc/ViewActions',['require','text!./view-actions.html'],function (require) {
...
define('ng-admin/Crud/misc/Compile',[],function () {
...
define('text!ng-admin/Crud/list/list.html',[],function () { return '\n<div class="row">\n\n    <view-actions override="listController.actions" entity="view.entity">\n        <create-button ng-if="!entity.isReadOnly" entity="entity"></create-button>\n    </view-actions>\n\n    <div class="filters col-md-3">\n        <form id="filter" ng-if="listController.displayFilterQuery" ng-submit="listController.filter()">\n            <div class="input-group">\n                <input type="text" placeholder="{{\'ngAdmin.static.FILTER\'|translate}}" class="form-control" ng-model="$parent.filterQuery">\n                <span class="input-group-btn">\n                    <button class="btn btn-default" type="submit"><span class="glyphicon glyphicon-search"></span></button>\n                    <button class="btn btn-default" type="button" ng-click="listController.clearFilter()"><span class="glyphicon glyphicon-remove"></span></button>\n                </span>\n            </div>\n        </form>\n    </div>\n\n    <div class="page-header">\n        <h1 compile="listController.title">\n           {{\'ngAdmin.static.SHOW_ALL\' | translate}} {{ \'ngAdmin.entities.\' + listController.view.entity.name() | translate | humanize:true | singularize }} \n        </h1>\n        <p class="lead" ng-if="listController.description">{{ listController.description }}</p>\n    </div>\n\n</div>\n\n<quick-filter></quick-filter>\n\n<div class="row">\n    <datagrid ng-init="name=view.name()"></datagrid>\n</div>\n';});


define('text!ng-admin/Crud/show/show.html',[],function () { return '\n<div class="row">\n\n    <view-actions override="showController.actions" entry="entry" entity="view.entity">\n        <list-button entity="entity"></list-button>\n        <edit-button ng-if="!entity.isReadOnly" entry="entry" entity="entity"></edit-button>\n        <delete-button ng-if="!entity.isReadOnly" entry="entry" entity="entity"></delete-button>\n    </view-actions>\n\n    <div class="page-header">\n        <h1 compile="showController.title">\n            {{\'ngAdmin.static.SHOW_INF\' | translate}}  {{ \'ngAdmin.entities.\' + showController.view.entity.name() | translate | humanize:true | singularize }}  "{{ entry.values.name ? entry.values.name : entry.values.label }}\n            {{ entry.values.fullname ? entry.values.fullname : entry.values.authority }}"\n          <!-- {{ showController.view.entity.name() | humanize:true | singularize }}  #{{ entry.identifierValue }}   Detail -->\n        </h1>\n        <p class="lead" ng-if="showController.description">{{ showController.description }}</p>\n    </div>\n</div>\n\n<div class="row form-horizontal" id="show-view">\n\n    <div class="form-group" ng-repeat="field in showController.fields | orderElement track by $index">\n\n        <label class="col-sm-2 control-label">{{ field.label() | translate }}</label>\n\n        <div class="col-sm-10 show-value" ng-switch="field.type()">\n\n            <string-column ng-switch-when="string"></string-column>\n\n            <password-column ng-switch-when="password"></password-column>\n\n            <text-column ng-switch-when="text"></text-column>\n\n            <email-column ng-switch-when="email"></email-column>\n\n            <number-column ng-switch-when="number"></number-column>\n\n            <date-column ng-switch-when="date"></date-column>\n\n            <boolean-column ng-switch-when="boolean"></boolean-column>\n\n            <choice-column ng-switch-when="choice"></choice-column>\n\n            <reference-column ng-switch-when="Reference"></reference-column>\n\n            <reference-many-column ng-switch-when="ReferenceMany"></reference-many-column>\n            \n            <reference-many-object-column ng-switch-when="ReferenceManyObject"></reference-many-object-column>\n\n            <reference-many-aggregation-column ng-switch-when="ReferenceManyAggregation" ng-init="columns=field.getRelationColumns()"></reference-many-aggregation-column>\n\n            <datagrid ng-switch-when="ReferencedList" ng-init="view=field.getReferencedView();columns=field.getGridColumns();entries=field.getEntries();name=field.getReferencedView().name()" with-pagination="false" ></datagrid>\n\n            <wysiwyg-column ng-switch-when="wysiwyg"></wysiwyg-column>\n\n            <template-column ng-switch-when="template"></template-column>\n        </div>\n    </div>\n</div>\n';});


define('text!ng-admin/Crud/form/create.html',[],function () { return '<div class="row">\n\n    <view-actions override="formController.actions" entry="entry" entity="view.entity">\n        <list-button entity="entity"></list-button>\n    </view-actions>\n\n    <div class="page-header">\n        <h1 compile="formController.title">\n            <!-- Create new {{ formController.view.entity.name() | humanize:true | singularize }} -->\n            {{\'ngAdmin.static.CREATE_NEW\' | translate}} {{ \'ngAdmin.entities.\' + formController.view.entity.name() |translate | humanize:true | singularize  }} \n\n        </h1>\n        <p class="lead" ng-if="formController.description">{{ formController.description }}</p>\n    </div>\n</div>\n\n<div class="row" id="edit-container">\n    <form class="form-horizontal" name="{{ formController.name}}" ng-submit="formController.submitCreation(createForm, $event)">\n        <div class="form-field form-group" ng-include="\'ng-admin/Crud/form/edit-attribute.html\'" ng-repeat="field in formController.fields | orderElement track by $index"></div>\n\n        <div class="form-group">\n            <div class="col-sm-offset-2 col-sm-10">\n                <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-ok"></span> {{\'ngAdmin.static.SUBMIT\' | translate}} </button>\n            </div>\n        </div>\n    </form>\n</div>\n';});


define('text!ng-admin/Crud/form/edit.html',[],function () { return '<div class="row">\n\n    <view-actions override="formController.actions" entry="entry" entity="view.entity">\n        <list-button entity="entity"></list-button>\n        <delete-button entry="entry" entity="entity"></delete-button>\n    </view-actions>\n\n    <div class="page-header">\n        <h1 compile="formController.title">\n            {{ \'ngAdmin.static.EDIT\' | translate }} {{ \'ngAdmin.entities.\' + formController.view.entity.name() | translate | humanize:true | singularize }} "{{ entry.values.label ? entry.values.label : entry.values.fullname}} {{entry.values.label ? entry.values.label : entry.values.name}}"\n        </h1>\n        <p class="lead" ng-if="formController.description">{{ formController.description }}</p>\n    </div>\n</div>\n\n<div class="row" id="edit-container">\n    <form class="form-horizontal" name="{{ formController.name }}" ng-submit="formController.submitEdition(editForm, $event)">\n        <div class="form-field form-group" ng-include="\'ng-admin/Crud/form/edit-attribute.html\'" ng-repeat="field in formController.fields | orderElement track by $index"></div>\n\n        <div class="form-group">\n            <div class="col-sm-offset-2 col-sm-10">\n                <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-ok"></span> {{\'ngAdmin.static.SAVE_CHANGES\'| translate}}</button>\n            </div>\n        </div>\n    </form>\n</div>\n';});


define('text!ng-admin/Crud/delete/delete.html',[],function () { return '<div class="row">\n\n    <view-actions override="deleteController.actions" entry="entry" entity="view.entity">\n        <list-button entity="entity"></list-button>\n    </view-actions>\n\n    <div class="page-header">\n        <!-- <h1 compile="deleteController.title">\n            Delete {{ deleteController.view.entity.name() | humanize:true | singularize }}  #{{ entry.identifierValue }}\n        </h1> -->\n        <h1 compile="deleteController.title">\n             {{\'ngAdmin.static.DELETE\' | translate}} {{ \'ngAdmin.entities.\' + deleteController.view.entity.name() |translate | humanize:true | singularize }} "{{ entry.values.label }} {{ entry.values.name ? entry.values.name : entry.values.label }}\n            {{ entry.values.fullname ? entry.values.fullname : entry.values.authority }}"\n        </h1> \n        <p class="lead" ng-if="deleteController.description">{{ deleteController.description }}</p>\n    </div>\n\n</div>\n\n<div class="row" id="edit-container">\n    <p>{{\'ngAdmin.static.ARE_SURE\' | translate}}</p>\n    <button class="btn btn-danger" ng-click="deleteController.deleteOne()">{{\'ngAdmin.static.YES\' |translate}}</button>\n    <button class="btn btn-default" ng-click="deleteController.back()">{{\'ngAdmin.static.NO\'|translate}}</button>\n</div>\n';});

/*global define*/

define('ng-admin/Crud/routing',['require','text!./list/list.html','text!./show/show.html','text!./form/create.html','text!./form/edit.html','text!./delete/delete.html'],function (require) {
...
define('CrudModule',['require','angular','inflection','angular-ui-router','angular-sanitize','angular-bootstrap-tpls','textangular','ngInflection','ng-admin/Crud/list/ListController','ng-admin/Crud/show/ShowController','ng-admin/Crud/form/FormController','ng-admin/Crud/delete/DeleteController','ng-admin/Crud/repository/RetrieveQueries','ng-admin/Crud/repository/CreateQueries','ng-admin/Crud/repository/UpdateQueries','ng-admin/Crud/repository/DeleteQueries','ng-admin/Crud/field/StringField','ng-admin/Crud/field/PasswordField','ng-admin/Crud/field/EmailField','ng-admin/Crud/field/TextField','ng-admin/Crud/field/NumberField','ng-admin/Crud/field/DateField','ng-admin/Crud/field/BooleanField','ng-admin/Crud/field/ChoiceField','ng-admin/Crud/field/ChoicesField','ng-admin/Crud/field/ReferenceField','ng-admin/Crud/field/ReferenceManyField','ng-admin/Crud/field/ReferenceManyObjectField','ng-admin/Crud/field/ReferenceManyAggregationField','ng-admin/Crud/field/WysiwygField','ng-admin/Crud/field/TemplateField','ng-admin/Crud/list/ListActions','ng-admin/Crud/list/Datagrid','ng-admin/Crud/list/DatagridPagination','ng-admin/Crud/list/QuickFilter','ng-admin/Crud/column/StringColumn','ng-admin/Crud/column/PasswordColumn','ng-admin/Crud/column/EmailColumn','ng-admin/Crud/column/TextColumn','ng-admin/Crud/column/NumberColumn','ng-admin/Crud/column/DateColumn','ng-admin/Crud/column/BooleanColumn','ng-admin/Crud/column/ChoiceColumn','ng-admin/Crud/column/ChoicesColumn','ng-admin/Crud/column/ReferenceColumn','ng-admin/Crud/column/ReferenceManyColumn','ng-admin/Crud/column/ReferenceManyObjectColumn','ng-admin/Crud/column/ReferenceManyObjectGrid','ng-admin/Crud/column/ReferenceManyAggregationGrid','ng-admin/Crud/column/ReferenceManyAggregationColumn','ng-admin/Crud/column/WysiwygColumn','ng-admin/Crud/column/TemplateColumn','ng-admin/Crud/button/BackButton','ng-admin/Crud/button/CreateButton','ng-admin/Crud/button/EditButton','ng-admin/Crud/button/ShowButton','ng-admin/Crud/button/ListButton','ng-admin/Crud/button/DeleteButton','ng-admin/Crud/misc/ViewActions','ng-admin/Crud/misc/Compile','ng-admin/Crud/misc/cacheTemplate','ng-admin/Crud/routing','humane','nprogress'],function (require) {
...
define('ng-admin',['require','angular','MainModule','CrudModule'],function (require) {
