...
define(function (require) {
    ...
    MainModule.constant('ReferenceManyObject', require('ng-admin/Main/component/service/config/ReferenceManyObject'));
    MainModule.constant('ReferenceManyAggregation', require('ng-admin/Main/component/service/config/ReferenceManyAggregation'));
    // Configuration view
