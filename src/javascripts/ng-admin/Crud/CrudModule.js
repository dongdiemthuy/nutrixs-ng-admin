...
define(function (require) {
    ...
    CrudModule.directive('referenceManyObjectField', require('ng-admin/Crud/field/ReferenceManyObjectField'));
    CrudModule.directive('referenceManyAggregationField', require('ng-admin/Crud/field/ReferenceManyAggregationField'));
    ...
    CrudModule.directive('referenceManyObjectColumn', require('ng-admin/Crud/column/ReferenceManyObjectColumn'));
    CrudModule.directive('referenceManyObjectGrid', require('ng-admin/Crud/column/ReferenceManyObjectGrid'));
    CrudModule.directive('referenceManyAggregationGrid', require('ng-admin/Crud/column/ReferenceManyAggregationGrid'));
    CrudModule.directive('referenceManyAggregationColumn', require('ng-admin/Crud/column/ReferenceManyAggregationColumn'));
